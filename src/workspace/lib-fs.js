/**
 * derived from https://github.com/GoogleChromeLabs/text-editor/blob/main/src/inline-scripts/fs-helpers.js
 */
 ...
 */
 export function getNewDirectoryHandle() {
  return window.showDirectoryPicker();
 }

 export async function getDirectoryEntries(fsHandle) {
   return 
 }
